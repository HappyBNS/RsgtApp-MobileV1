...
{
    public class ContainerRequestViewModel : INotifyPropertyChanged
    {
        //CMS caption list
        ...
        public ContainerRequestViewModel(string strLicenseNo, string strBOL, string fstrContainerNo, string strRequest)
        {
            ...
            ButtonClicked = new Command(async () => await buttonClicked(strLicenseNo, strBOL, fstrContainerNo, strRequest), () => !IsBusy);
            ButtonCancelClicked = new Command(async () => await buttonCancelClicked(strLicenseNo, strBOL, fstrContainerNo, strRequest), () => !IsBusy);
        ...
        public async void assignContent()
        {
            ...
            strServerSlowMsg = dbLayer.getCaption("strServerSlowMsg", objCMS);
        }
        /// <summary>
        ...
        /// <param name="strRequest"></param>
        /// <returns></returns>
        private async Task buttonClicked(string strLicenseNo, string strBOL, string fstrContainerNo, string strRequest)
        {
            IsBusy = true;
        ...
        /// <summary>
        /// Button Cancel clicked Function
        /// </summary>
        /// <param name="strLicenseNo"></param>
        /// <param name="strBOL"></param>
        /// <param name="fstrContainerNo"></param>
        /// <param name="strRequest"></param>
        /// <returns></returns>
        private async Task buttonCancelClicked(string strLicenseNo, string strBOL, string fstrContainerNo, string strRequest)
        {
            IsBusy = true;
            StackBOLRequestData = false;
            await Task.Delay(1000);
            ...
            await App.Current.MainPage?.Navigation.PushAsync(new ContainerPhotoDetails(strBOL, fstrContainerNo));
            StackBOLRequestData = true;
            IsBusy = false;
        }
    }
