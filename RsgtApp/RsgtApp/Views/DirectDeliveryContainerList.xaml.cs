...
namespace RsgtApp.Views
{
    ...
    public partial class DirectDeliveryContainerList : ContentPage
    {
        /// <summary>
        ...
        public DirectDeliveryContainerList(string fstrBayanNo)
        {
            InitializeComponent();
            this.BindingContext = new DirectDeliveryContainerListViewModel(fstrBayanNo);
        }
