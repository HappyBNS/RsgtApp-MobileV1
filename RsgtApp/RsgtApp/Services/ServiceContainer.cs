...
{
    /*
      * This is a trimmed-down version of the ServiceContainer class from the XamCAT repository. 
      * It will be used as a light-weight IoC (Inversion of Control) container.
    */
