...
namespace RsgtApp.Services
{
    /*
      ...
      * 
      * Class NotificationRegistrationService(Services Folder) -----> Implements ----> INotificationRegistrationService(Services Folder)
    */
    public class NotificationRegistrationService : INotificationRegistrationService
    {
        ...
        IDeviceInstallationService DeviceInstallationService => _deviceInstallationService ?? (_deviceInstallationService = ServiceContainer.Resolve<IDeviceInstallationService>());
        ...
        public async Task DeregisterDeviceAsync()
        {
            ...
            await SendAsync(HttpMethod.Delete, $"{RequestUrl}/{deviceId}").ConfigureAwait(false);
